        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EquippedSkinId = table.Column<int>(type: "integer", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                table: "Skins",
                columns: new[] { "Id", "Description", "Name", "PointCost", "Theme" },
                values: new object[,]
                {
                    { 1, "Cool blue tones.", "Ocean", 100, "ocean" },
                    { 2, "Warm orange energy.", "Sunset", 200, "sunset" },
                    { 3, "Deep purple mystery.", "Midnight", 300, "midnight" },
                    { 4, "Bold pink for champions.", "Cherry", 500, "cherry" }
                });
